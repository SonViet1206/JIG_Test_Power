...
namespace DefaultNS
{
    public partial class PowerBoard : UserControl
    {
        ...
        public void Start()
        {
            ...
            _port_name = iniFile.IniReadValue("COMMUNICATION", "RelaysBoardCommPort", "COM8");
           
            lblCaption.Text = "POWER BOARD - " + _port_name;
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show(ex.Message, "Lỗi kết nối với POWERBOARD",MessageBoxButtons.OK,MessageBoxIcon.Error);
            }
            finally
            {
                portCOMM.Close();
