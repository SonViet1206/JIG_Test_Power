...
public class Conv
{
    ...
    public static string atoBnr(object obj)
    {
        string res = "";
        try
        {
            int value = Conv.atoi32(obj);
    ...
    public static decimal atodec(object obj, int default_value)
    {
        decimal retValue = default_value;
        try
        {
    ...
    public static decimal atodec(object obj) { return atodec(obj, 0); }
