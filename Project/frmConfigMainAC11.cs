...
namespace DefaultNS
{
    public partial class frmConfigMainAC11 : Form
    {
        public frmConfigMainAC11()
        {
            InitializeComponent();
        }
        ...
        private void frmConfig_Load(object sender, EventArgs e)
        {
            ...
            txtTonyVersion.Text = Conv.atos(SQLite.ExecuteScalar("SELECT ItemValue FROM tbl_common_settings WHERE ItemName='TonyVersion'"));
        }
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            SQLite.ExecuteNonQuery("UPDATE tbl_common_settings SET ItemValue='" + txtTonyVersion.Text + "' WHERE ItemName='TonyVersion'");
        ...
        {
            SQLite.ExecuteNonQuery("UPDATE tbl_common_settings SET ItemValue='" + "0|0|" + DateTime.Now.Day + "' WHERE ItemName='Password3'");
        }
    }
}
