...
namespace DefaultNS
{
    public partial class DUT_PLC : UserControl
    {
        ...
        {
            string res;
            res = ExecuteTCPCommand("stop", "current mode", 50000);
            return (res == "normal");
        }
        ...
        {
            return ExecuteTCPCommand("test_eth", "eth test", 8000);
        }
