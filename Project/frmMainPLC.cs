                ...
                while (thread_started)
                {
                    ...
                    try
                    {
                        ...
                        else if (test_steep == (int)PLC_STEEPS.CALIBRATION_ADC_E) //
                        {
                            ...
                            Conv.delay_ms(5000); // chờ mạch calib
                        ...
                        else if (test_steep == (int)PLC_STEEPS.CALIBRATION_ADC_A) //
                        {
                            ...
                            Conv.delay_ms(9000); // chờ mạch calib
                        ...
                        else if (test_steep == (int)PLC_STEEPS.TEMP1_TEST) //
                        {
                            ...
                            dgvTestList.Rows[test_steep].Cells["CheckValue"].Value = "" + value1 + "±" + error1 + "|" + value2 + "±" + error2 + "|" + value3 + "±" + error3 + "|" + value4 + "±" + error4;
                            ...
                            dgvTestList.Rows[test_steep].Cells["ReadValue"].Value += "|" + retValue;
                            testOK = (Math.Abs(retValueInt1 - value1) <= error1) && (Math.Abs(retValueInt2 - value2) <= error2) && (Math.Abs(retValueInt3 - value3) <= error3) && (Math.Abs(retValueInt4 - value4) <= error4);
                        }
                        else if (test_steep == (int)PLC_STEEPS.TEMP2_TEST) //
                        {
                            ...
                            //dgvTestList.Rows[test_steep].Cells["CheckValue"].Value = "62±" + ((int)(62 * percent)).ToString() + "|116±" + ((int)(116 * percent)).ToString() + "|142±" + ((int)(142 * percent)).ToString() + "|166±" + ((int)(166 * percent)).ToString();// "62±6|116±11|142±14|166±16";
                            dgvTestList.Rows[test_steep].Cells["CheckValue"].Value = "" + value1 + "±" + error1 + "|" + value2 + "±" + error2 + "|" + value3 + "±" + error3 + "|" + value4 + "±" + error4;
