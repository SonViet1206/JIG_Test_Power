...
namespace DefaultNS
{
    class RestApiHelper
    {
        ...
        public static Model.OutputGetSNStatus GetSNStatus(string serial, string machine_name)
        {
            ...
            HttpWebRequest request = (HttpWebRequest)WebRequest.Create(Url + GetSNStatusApiString);
        ...
        public static Model.OutputInsertPassFailDetailTestCase InsertPassFailDetailTestCase(string serial, string machine_name, string user_id, DataTable dtabTest)
        {
            ...
            HttpWebRequest request = (HttpWebRequest)WebRequest.Create(Url + InsertPassFailDetailTestCaseApiString);
        ...
        public static Model.OutputInsertDetailTestCase InsertDetailTestCase(string serial, string machine_name, DataTable dtabTest)
        {
            ...
            HttpWebRequest request = (HttpWebRequest)WebRequest.Create(Url + InsertDetailTestCaseApiString);
        ...
        public static OutputUpdateFirmwareInfo UpdateFirmwareInfo(string serial, string machine_name, string user_name, string firmware, string firmware_version)
        {
            OutputUpdateFirmwareInfo res;
            HttpWebRequest request = (HttpWebRequest)WebRequest.Create(Url + UpdateFirmwareInfoApiString);
            ...
            try
            {
                ...
                if (httpWebResponse.StatusCode == HttpStatusCode.OK)
                {
                    ...
                    return new OutputUpdateFirmwareInfo()
                    {
                        SN = _sn,
                        MachineName = _machinename,
                        Result = _result,
        ...
        public static OutPutGetSNInfo GetSNInfo(string serial, string machine_name, string user_name)
        {
            OutPutGetSNInfo res;
            HttpWebRequest request = (HttpWebRequest)WebRequest.Create(Url + GetSNInfoApiString);
